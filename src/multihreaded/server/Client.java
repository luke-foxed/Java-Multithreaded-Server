...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldSearchSurname.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldSearchSurnameActionPerformed(evt);
            }
        });
        jTextFieldSearchSurname.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldSearchSurnameKeyTyped(evt);
            }
        });
    ...
    private void jTableStudentsMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableStudentsMousePressed
        getSelectedRow();
    ...
    private void jTextFieldStudentIDKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldStudentIDKeyTyped
        jTextFieldStudentID.addKeyListener(new KeyAdapter() {
            @Override
            public void keyTyped(KeyEvent e) {
                if (jTextFieldStudentID.getText().length() >= 9) // limit to 9 characters
                {
                    e.consume();
                }
            }
    ...
    private void jTextFieldSIDKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldSIDKeyTyped
        jTextFieldSID.addKeyListener(new KeyAdapter() {
            @Override
            public void keyTyped(KeyEvent e) {
                if (jTextFieldSID.getText().length() >= 10) // limit to 10 characters
                {
                    e.consume();
                }
            }
        });
    }//GEN-LAST:event_jTextFieldSIDKeyTyped

    private void jTextFieldSurnameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldSurnameKeyPressed
        jTextFieldSurname.addKeyListener(new KeyAdapter() {
            @Override
            public void keyTyped(KeyEvent e) {
                if (jTextFieldSurname.getText().length() >= 20) // limit to 9 characters
                {
                    e.consume();
                }
            }
        });
    }//GEN-LAST:event_jTextFieldSurnameKeyPressed
    ...
    private void jTextFieldFirstNameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldFirstNameKeyPressed
        jTextFieldFirstName.addKeyListener(new KeyAdapter() {
            @Override
            public void keyTyped(KeyEvent e) {
                if (jTextFieldFirstName.getText().length() >= 20) // limit to 9 characters
                {
                    e.consume();
                }
            }
    ...
    private void jTextFieldSearchSurnameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldSearchSurnameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldSearchSurnameActionPerformed

    private void jTextFieldSearchSurnameKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldSearchSurnameKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldSearchSurnameKeyTyped
 ...
 /* Create and display the form */
    ...
    private boolean checkErrors() {
        boolean isError;
        isError = Arrays.asList(jTextFieldFirstName.getText(),
                jTextFieldSurname.getText(),
                jTextFieldStudentID.getText(),
                jTextFieldSID.getText()
        ).contains("");
        return isError;
    }
